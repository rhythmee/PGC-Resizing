...
# RM-Version: H-2013.03 (April 15, 2013)
...
set DCRM_SDC_INPUT_FILE                                 create_clock.sdc
...
set DCRM_FINAL_VERILOG_OUTPUT_FILE_FLAT_BUS             ${DESIGN_NAME}.mapped.flat_bus.v
set DCRM_FINAL_SDC_OUTPUT_FILE                          ${DESIGN_NAME}.mapped.sdc
set DCRM_FINAL_SDC_OUTPUT_FILE_FLAT_BUS                 ${DESIGN_NAME}.mapped.flat_bus.sdc

set DCRM_FINAL_NET_REPORT							    ${DESIGN_NAME}.mapped.flat_net
#-----------------------------------------------------------------------------------------
# Additional Files for experiments
#-----------------------------------------------------------------------------------------
