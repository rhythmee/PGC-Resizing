# Example of inserting PGC (tech:snps32)
# Trick to make PGC routing blockage
# original directory at wappinger server: /home/ischo/PGC_OPT/300_routability/synthesis/200_ICC2/scripts/physical_snps32.tcl
...
create_cell_array -lib_cell HEADX32_RVT -x_pitch 19.98 -y_pitch 9.99
...
write_def -include_tech_via_definitions -include {nets cells specialnets vias rows_tracks ports} ./results/$ver_name/${DESIGN}.def 
...
# detailed routing 3 times incrementally
set total_iter 3
set step_iter 1
set count_iter 0
...
# Insert PGC(2X) array 
create_cell_array -lib_cell HEADX2_RVT -x_pitch 10 -y_pitch 10 
