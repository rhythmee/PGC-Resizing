...
set LEF_FILES {}
set DB_FILES {/home/hot_data/DB/snps14/lib/stdcell_rvt/db_nldm/saed14rvt_pg_ss0p72v125c.db}
...
create_workspace saed14rvt_pg_ss0p72v125c -scale_factor 10000
foreach frame $FRAME_LIBS {
  read_ndm $frame
}
read_db $DB_FILES
process_workspaces -check_options {-allow_missing} -force -directory CLIBs -output saed14rvt_pg_ss0p72v125c.ndm
